<?php
    ...
    $stmt = $pdo->prepare("SELECT * FROM tbl_enquiry");
    $stmt->execute();
    $res = $stmt->fetchAll(PDO::FETCH_OBJ);

    if (isset($_GET['action']) && $_GET['action'] == 'delete') {
        $stmt = $pdo->prepare("DELETE FROM tbl_enquiry WHERE id = ?");
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <div class="row">
                                        <h4 class="card-title">All Enquries</h4>
                                        <p class="card-category">List Of enquries</p>
                                    </div>
                                </div>
